...
import { Clock, Eye, CheckCircle2, ArrowRight, UserPlus } from "lucide-react";
    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <div className="flex flex-col items-center justify-center pt-10 pb-6">
        ...
        <p className="text-sm text-muted-foreground text-center max-w-[280px]">
          Daftar sekarang untuk mulai mengelola presensi Anda.
        </p>
      </div>
      ...
      <div className="flex-1 px-4 pb-8 space-y-6 max-w-md w-full mx-auto">
        ...
        <div className="bg-card rounded-2xl p-4 shadow-sm border border-border">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-semibold text-foreground">Daftar Sebagai</h3>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <svg className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                <Input type="text" placeholder="Budi Santoso" className="pl-9 h-12 bg-transparent" required />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input type="email" placeholder="nama@kantor.co.id" className="pl-9 h-12 bg-transparent" required />
              </div>
            </div>
